...
<body class="min-h-screen flex flex-col dark:bg-gray-900 bg-gray-200">
    ...
    <!-- Main Content -->
  <main class="p-4 flex-grow flex items-center justify-center">
    <div class="w-full lg:w-[90%] mx-auto flex flex-col lg:flex-row justify-start h-full gap-4 items-stretch">
        <!-- Login -->
        <div class="bg-white dark:bg-gray-800 rounded-lg w-full md:max-w-md h-full shadow-lg">
            ...
            <!-- Banner Image -->
            <div id="gallery" class="w-full lg:w-[80%] relative" data-carousel="slide">
            <div class="relative overflow-hidden rounded-lg h-[250px] lg:h-full">
    ...
    <!-- Help Section -->
    <div class="bg-blue-900 text-white p-2 dark:bg-gray-800">
        <div class="container mx-auto">
            <h4 class="font-bold mb-2">En caso de no poder ingresar:</h4>
            <ol class="list-decimal list-inside">
                <li>Ingresar al servicio de correo electrónico de la UNAH
                    <a href="https://mail.unah.edu.hn/"> https://mail.unah.edu.hn </a>
                </li>
                <li>Seleccionar la opción: "Recuperar contraseña"</li>
            </ol>
        </div>
    </div>

    <!-- Footer -->
    <footer class="bg-amber-400 p-6 w-full dark:bg-gray-900">
        <div class="container mx-auto grid md:grid-cols-2 gap-8">
            ...
            <div class="text-navy-900 dark:text-gray-900">
                <p class="text-justify dark:text-gray-200">
                    La vinculación académica con la sociedad, junto a la investigación científica y la docencia son funciones esenciales de una universidad. Los vínculos académicos que la Universidad establece con el Estado, los sectores productivos y la sociedad civil posibilitan que los conocimientos científicos...
                </p>
            </div>
        </div>
    </footer>
