...
<body>
    ...
    <table class="tabla-responsables">
        ...
        <thead>
            <tr>
                <th colspan="2" style="text-align:center; background:#0f0258; color:#fff;">Datos del proyecto ejecutado:</th>
            </tr>
        </thead>
        <tbody>
            <tr>
            ...
            <tr>
                ...
                <td>{{ $fechaInicio }} hasta {{ $fechaFinal }}</td>
            </tr>
            <tr>
                <td>Beneficiarios:</td>
                <td>{{ $beneficiarios }}</td>
            ...
            <tr>
                <td>Fecha de informe intermedio:</td>
                <td>{{ $fechaInformeIntermedio }}</td>
            </tr>
            <tr>
                <td>Fecha de informe final:</td>
                <td>{{ $fechaInformeFinal }}</td>
            </tr>

            <tr>
                <td>Presupuesto ejecutado (L):</td>
                <td>{{ $presupuestoEjecutado }}</td>
            </tr>
        </tbody>
    </table>
        ...
        <p id="fecha-automatica">
            Por lo anterior, se extiende la CONSTANCIA DE FINALIZACIÓN del proyecto en Ciudad Universitaria José
            Trinidad Reyes, a los
