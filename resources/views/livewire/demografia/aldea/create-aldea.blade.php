<div>
    <div class="mb-4">
        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Crear una nueva Aldea</h3>
        <p class="text-sm text-gray-500 dark:text-gray-400">Crea una nueva aldea con sus datos asociados.</p>
    </div>
