<div>
    <div class="mb-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
        <div>
            ...
            <p class="text-zinc-500 dark:text-gray-400 font-medium text-sm">A continuación se muestra el listado de aldeas.</p>
        </div>
    </div>
    <div class="mb-3">
        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm">
            <thead class="bg-gray-50 dark:bg-gray-800">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left font-semibold text-gray-600 dark:text-gray-300">Aldea</th>
            ...
            <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-100 dark:divide-gray-800">
                ...
                @empty
                    <tr><td colspan="3" class="px-4 py-6 text-center text-gray-500 dark:text-gray-400">Sin registros.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
    ...
    <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-50" wire:click.self="$set('editModal', false)">
        <div class="bg-white dark:bg-gray-900 rounded-lg shadow-xl w-full max-w-lg p-6 mx-4">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Editar Aldea</h3>
            <div class="grid grid-cols-1 gap-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Municipio *</label>
                    <select wire:model="edit_municipio_id" class="w-full rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-sm">
