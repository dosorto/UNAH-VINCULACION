<div>
    <div class="mb-4 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
        <div>
            <p class="text-zinc-950 dark:text-white font-bold mb-1">Listado de ciudades</p>
            <p class="text-zinc-500 dark:text-gray-400 font-medium text-sm">A continuación se muestra el listado de ciudades.</p>
        </div>
    </div>
    <div class="mb-3">
        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm">
            <thead class="bg-gray-50 dark:bg-gray-800">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left font-semibold text-gray-600 dark:text-gray-300">Ciudad</th>
                    <th class="px-4 py-3 text-left font-semibold text-gray-600 dark:text-gray-300">Código Postal</th>
