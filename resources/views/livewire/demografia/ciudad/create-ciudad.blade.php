<div>
    <div class="mb-4">
        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Crear una nueva Ciudad</h3>
        <p class="text-sm text-gray-500 dark:text-gray-400">Crea una nueva ciudad con sus datos asociados.</p>
    </div>
    ...
    <form wire:submit="create">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div class="sm:col-span-2">
                ...
                @error('municipio_id') <p class="mt-1 text-xs text-red-600">{{ $message }}</p> @enderror
            </div>
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Código Postal <span class="text-red-500">*</span></label>
