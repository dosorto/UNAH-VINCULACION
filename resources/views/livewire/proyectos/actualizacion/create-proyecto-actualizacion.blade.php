        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <div class="flex items-center justify-between py-2 px-3 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700 rounded-lg mb-2">
                    ...
                    <button type="button" x-on:click.prevent="confirmDialog('¿Reincorporar a este integrante y cancelar la baja?').then((ok) => ok && $wire.reincorporar({{ $baja->id }}))" type="button"
            ...
            <div>
                ...
                <div class="flex items-center justify-between py-2 px-3 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-700 rounded-lg mb-2">
                    ...
                    <button type="button" x-on:click.prevent="confirmDialog('¿Cancelar esta solicitud de incorporación?', { type: 'danger' }).then((ok) => ok && $wire.cancelarSolicitud({{ $nuevo->id }}))" type="button"
