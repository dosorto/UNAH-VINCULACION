        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            @foreach ($tiposAccion as $tipo)
                ...
                <div class="flex flex-col items-center gap-3">
                    @if ($cardHref)
                        <a href="{{ $cardHref }}" class="{{ $cardClasses }} {{ $hoverClasses }}">
                    @else
                        <div class="{{ $cardClasses }} {{ $hoverClasses }} {{ $activo ? '' : 'pointer-events-none' }}">
                    @endif
                        <span
                        ...
                        <div class="flex flex-col items-center">
                            <div
                                ...
                                {!! $iconos[$tipo->icono] ?? $iconoDefault !!}
                            </div>
                            <h3 class="text-xl font-bold text-blue-900 dark:text-blue-200 mb-2 text-center">
                                {{ $tipo->nombre }}
                            </h3>
                            <p class="text-gray-600 dark:text-gray-300 text-center text-base">
                                {{ $tipo->descripcion }}
                            </p>
                        </div>
                    @if ($cardHref)
