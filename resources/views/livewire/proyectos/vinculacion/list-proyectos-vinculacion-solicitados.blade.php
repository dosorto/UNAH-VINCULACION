<div>
    ...
    <div class="overflow-x-auto rounded-lg border border-gray-200 dark:border-gray-700">
        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700 text-sm">
            ...
            <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-100 dark:divide-gray-800">
                ...
                @empty
                    <tr><td colspan="4" class="px-4 py-6 text-center text-gray-500 dark:text-gray-400">No hay proyectos solicitados pendientes.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
    ...
    {{-- Modal Aprobar (con código/dictamen) --}}
    @if ($aprobarModal)
    <div class="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/50">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-xl w-full max-w-lg">
            <div class="flex justify-between items-center p-4 border-b border-gray-200 dark:border-gray-700">
                <h3 class="text-lg font-semibold dark:text-white">Aprobar Proyecto</h3>
                <button wire:click="$set('aprobarModal', false)" class="text-gray-400 hover:text-gray-600 text-2xl leading-none">&times;</button>
            </div>
            <div class="p-4 space-y-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">N° Dictamen (generado)</label>
                    <input type="text" wire:model="aprobar_dictamen" readonly
                           class="w-full rounded-md border border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-700 px-3 py-2 text-sm text-gray-900 dark:text-white shadow-sm">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Código del Proyecto</label>
                    <input type="text" wire:model="aprobar_codigo"
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">Al aprobar, el proyecto pasará a "En revisión final".</p>
                <div class="flex justify-end gap-3">
