<div class="mb-4 mt-4 flex justify-between items-center">
    <div
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <a href="{{ route('selectorCategoria') }}"
                ...
                <div class="flex flex-col items-center">
                    ...
                    <h3 class="text-xl font-bold text-blue-900 dark:text-blue-200 mb-2 text-center">Desarrollo
                        Local y Regional</h3>
            ...
            <a href="javascript:void(0)"
                ...
                <div class="flex flex-col items-center">
                    ...
                    <h3 class="text-xl font-bold text-yellow-900 dark:text-yellow-200 mb-2 text-center">PPS, Voluntariado y Gestión del Riesgo</h3>
            ...
            <a href="javascript:void(0)"
                ...
                <div class="flex flex-col items-center">
                    ...
                    <h3 class="text-xl font-bold text-purple-900 dark:text-purple-200 mb-2 text-center">Vinculos académicos
                    </h3>
