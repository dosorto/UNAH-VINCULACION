...
@if (
    ...
    <div><div class="grid grid-cols-1 md:grid-cols-2 sm:grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="grid grid-cols-1 items-center border-gray-200 border-t dark:border-gray-700 justify-between">
                    <div class="flex justify-between items-center pt-5">
                        ...
                        <select wire:model.lazy="selectedYear" class="text-sm font-medium bg-transparent border-none focus:ring-0 text-gray-500 dark:text-gray-400 hover:text-gray-900 text-center inline-flex items-center dark:hover:text-white">
                            @foreach($años as $año)
                                @if ($año == now()->year)
                                    <option value="{{ $año }}" selected class="bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200">Año actual {{$año}}</option>
                                @else
                                <option value="{{ $año }}" class="bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200">Año {{ $año }}</option>
                                @endif
                            @endforeach
                        </select>
                        <a href="#"
                        ...
                        <tbody>
                            @forelse($proyectosTable as $proyecto)
                                <tr
                                    ...
                                    <th scope="row"
                                        class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white truncate max-w-xs relative group">
    ...
    <div class="container mx-auto py-6">
        ...
        <div class="flex flex-wrap -mx-3 -mb-8">
            <div class="w-full md:w-1/2 lg:w-1/4 px-3 mb-6">
                <div class="max-w-md mx-auto h-full px-4 pt-6 pb-12 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl">
                    <div class="flex items-center justify-between mb-3">
                        <div class="flex items-center">
                            <h3 class="text-lg text-gray-900 dark:text-white font-semibold mr-2">Borrador</h3>
                            <span class="inline-flex items-center justify-center w-6 h-7 rounded-full bg-gray-200 dark:bg-gray-700 text-xs font-medium text-gray-600 dark:text-gray-400">{{$enBorradorCount}}</span>
                        </div>
                    </div>
                ...
                <div class="max-w-md mx-auto h-full px-4 pt-6 pb-12 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl">
                    <div class="flex items-center justify-between mb-3">
                        <div class="flex items-center">
                            ...
                            <span class="inline-flex items-center justify-center w-6 h-7 rounded-full bg-gray-200 dark:bg-gray-700 text-xs font-medium text-gray-600 dark:text-gray-400">{{$enRevisionCount}}</span>
                        </div>
                    </div>
                ...
                <div class="max-w-md mx-auto h-full px-4 pt-6 pb-12 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl">
                    <div class="flex items-center justify-between mb-3">
                        <div class="flex items-center">
                            ...
                            <span class="inline-flex items-center justify-center w-6 h-7 rounded-full bg-gray-200 dark:bg-gray-700 text-xs font-medium text-gray-600 dark:text-gray-400">{{$enEjecucionCount}}</span>
                        </div>
                    </div>
                ...
                <div class="max-w-md mx-auto h-full px-4 pt-6 pb-12 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl">
                    <div class="flex items-center justify-between mb-3">
                        <div class="flex items-center">
                            ...
                            <span class="inline-flex items-center justify-center w-6 h-7 rounded-full bg-gray-200 dark:bg-gray-700 text-xs font-medium text-gray-600 dark:text-gray-400">{{$enFinalizadosCount}}</span>
                        </div>
                    </div>
