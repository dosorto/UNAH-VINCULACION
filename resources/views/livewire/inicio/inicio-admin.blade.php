<div>
    <div class="grid grid-cols-1 md:grid-cols-2 sm:grid-cols-1 lg:grid-cols-3 gap-6">
                                ...
                                <div class="container px-4 mx-auto">
                                    <div class="relative overflow-hidden">
                                        <div class="relative max-w-sm mx-auto lg:mx-0 mb-2 lg:mb-0">
                                            ...
                                            <p class="font-medium text-blue-200">Aquí podrás darle seguimiento a tus proyectos.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="ml-5">
                                        ...
                                        <h4 class="text-2xl font-bold text-gray-900 dark:text-white">{{$proyectos->count()}}</h4>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div class="ml-5">
                                        <p class="text-base font-medium text-gray-600 dark:text-gray-400">Finalizados</p>
                                        <h4 class="text-2xl font-bold text-gray-900 dark:text-white">{{$finalizados->count()}}</h4>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div class="ml-5">
                                        ...
                                        <h4 class="text-2xl font-bold text-gray-900 dark:text-white">{{$subsanacion->count()}}</h4>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div class="ml-5">
                                        <p class="text-base font-medium text-gray-600 dark:text-gray-400">Empleados</p>
                                        <h4 class="text-2xl font-bold text-gray-900 dark:text-white">{{$empleados}}</h4>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div
                                        class="flex items-center justify-center w-14 h-14 rounded-full bg-teal-100 dark:bg-teal-700">
                                          <svg class="w-8 h-8 text-teal-600 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                            <path fill-rule="evenodd" d="M8 3a1 1 0 0 1 1-1h6a1 1 0 0 1 1 1h2a2 2 0 0 1 2 2v15a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h2Zm6 1h-4v2H9a1 1 0 0 0 0 2h6a1 1 0 1 0 0-2h-1V4Zm-3 8a1 1 0 0 1 1-1h3a1 1 0 1 1 0 2h-3a1 1 0 0 1-1-1Zm-2-1a1 1 0 1 0 0 2h.01a1 1 0 1 0 0-2H9Zm2 5a1 1 0 0 1 1-1h3a1 1 0 1 1 0 2h-3a1 1 0 0 1-1-1Zm-2-1a1 1 0 1 0 0 2h.01a1 1 0 1 0 0-2H9Z" clip-rule="evenodd"/>
                                          </svg>
                                    </div>
                                    <div class="ml-5">
                                        <p class="text-base font-medium text-gray-600 dark:text-gray-400">Borradores</p>
                                        <h4 class="text-2xl font-bold text-gray-900 dark:text-white">{{$borrador->count()}}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section class="grid grid-cols-1 md:grid-cols-2 md:col-span-2 sm:md:col-span-2 lg:md:col-span-1 sm:grid-cols-1 lg:grid-cols-1 gap-6">
            <div>
                <div
                    ...
                    <a class="flex p-4 items-center justify-between hover:bg-gray-100 dark:hover:bg-gray-700 rounded-xl transition duration-150"
                        ...
                        <div class="flex items-center pr-2">
                            <div
                                ...
                                <svg class="w-6 h-6 text-yellow-500 dark:text-yellow-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                                    <path d="M17.133 12.632v-1.8a5.406 5.406 0 0 0-4.154-5.262.955.955 0 0 0 .021-.106V3.1a1 1 0 0 0-2 0v2.364a.955.955 0 0 0 .021.106 5.406 5.406 0 0 0-4.154 5.262v1.8C6.867 15.018 5 15.614 5 16.807 5 17.4 5 18 5.538 18h12.924C19 18 19 17.4 19 16.807c0-1.193-1.867-1.789-1.867-4.175ZM6 6a1 1 0 0 1-.707-.293l-1-1a1 1 0 0 1 1.414-1.414l1 1A1 1 0 0 1 6 6Zm-2 4H3a1 1 0 0 1 0-2h1a1 1 0 1 1 0 2Zm14-4a1 1 0 0 1-.707-1.707l1-1a1 1 0 1 1 1.414 1.414l-1 1A1 1 0 0 1 18 6Zm3 4h-1a1 1 0 1 1 0-2h1a1 1 0 1 1 0 2ZM8.823 19a3.453 3.453 0 0 0 6.354 0H8.823Z"/>
                                  </svg>
                            </div>
                            <div>
                                <h5 class="text-sm text-gray-900 dark:text-white font-medium mb-1">{{ $activity->description }} {{ $activity->subject->nombre_proyecto ?? '' }} – por {{ $activity->causer->name ?? 'Sistema' }}</h5>
                                <p class="text-xs text-gray-600 dark:text-gray-400 font-semibold">{{ $activity->created_at->diffForHumans() }}</p>
                            </div>
                        </div>
                    </a>
                    @empty
            ...
            <div>
                <div
                    ...
                    <h4 class="text-lg text-gray-900 dark:text-white font-semibold mb-6">Proyectos por empleados</h4>
                    ...
                    <a class="flex p-4 items-center justify-between rounded-xl transition duration-150 hover:bg-gray-100 dark:hover:bg-gray-700"
                        ...
                        <div class="flex items-center pr-2">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-600 dark:text-gray-400 font-semibold">Tiene {{ $empleado->proyectos_count }} proyectos.</p>
                            </div>
                        </div>
                    </a>
                    @empty
                    <p class="text-xs text-gray-600 dark:text-gray-400 font-semibold">No hay empleados registrados</p>
                    @endforelse
                </div>
            </div>
        </section>
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="ml-5">
                                        ...
                                        <h4 class="text-2xl font-bold text-gray-900 dark:text-white">{{$proyectosUser->count()}}</h4>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div class="ml-5">
                                        <p class="text-base font-medium text-gray-600 dark:text-gray-400">Finalizados</p>
                                        <h4 class="text-2xl font-bold text-gray-900 dark:text-white">{{$finalizadosUser->count()}}</h4>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div class="ml-5">
                                        ...
                                        <h4 class="text-2xl font-bold text-gray-900 dark:text-white">{{$subsanacionUser->count()}}</h4>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div class="ml-5">
                                        <p class="text-base font-medium text-gray-600 dark:text-gray-400">Borradores</p>
                                        <h4 class="text-2xl font-bold text-gray-900 dark:text-white">{{$borradorUser->count()}}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
