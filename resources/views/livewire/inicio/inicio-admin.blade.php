     ...
     <div class="container mx-auto py-6">
        <div class="flex flex-wrap -mx-3 -mb-8">
            <div class="w-full md:w-1/2 lg:w-1/4 px-3 mb-8">
                <div class="max-w-sm mx-auto h-full px-4 pt-6 pb-24 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl">
...
@if (auth()->user()->hasPermissionTo('ver-dashboard-docente') &&
    ...
    <!-- tabla de ultimos usuarios -->
    <div>
        <div class="w-full pt-6 md:pt-6 sm:pt-0 lg:pt-0">
            <div
                class="h-full bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
