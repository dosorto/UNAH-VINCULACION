<div>
    ...
    @if (config('services.microsoft.enabled'))
        <div class="relative my-4">
            ...
            <div class="relative flex justify-center text-sm">
                <span class="bg-white px-2 text-gray-500 dark:bg-gray-800 dark:text-gray-400">o usa tu contraseña</span>
            </div>
        </div>
    @endif
    ...
    <form wire:submit="create">
        ...
        <div class="mb-4 text-right">
            <a href="{{ route('password.request') }}" class="text-sm font-medium text-blue-800 hover:underline dark:text-blue-400">
        ...
        <button
            ...
            wire:target="create"
            class="w-full rounded-lg bg-blue-900 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-yellow-300 disabled:cursor-wait disabled:opacity-70 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
        >
            <span wire:loading.remove wire:target="create">Iniciar sesión</span>
            <span wire:loading wire:target="create">Verificando...</span>
        </button>
    </form>
</div>
