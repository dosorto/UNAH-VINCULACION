        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                @elseif ($isEditableState)
                    ...
                    <button type="button" x-on:click.prevent="confirmDialog('¿Deseas borrar este programa? Esta acción no se puede deshacer.', { type: 'danger' }).then((ok) => ok && $wire.deleteDraft())" class="rounded-full border border-rose-300 px-4 py-2 text-sm font-medium text-rose-700 dark:border-rose-800 dark:text-rose-300">Borrar</button>
                @endif
            </div>
        </div>
