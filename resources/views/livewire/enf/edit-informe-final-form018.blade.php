        ...
        <div class="mt-8 flex flex-col gap-3 border-t border-gray-200 pt-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex flex-wrap items-center justify-end gap-3">
                ...
                @else
                    ...
                    <button type="button" wire:click="validarInforme" wire:confirm="Confirma que desea marcar completo el informe final FORM-DVUS-018?" class="{{ $button }} bg-green-700 text-white">Validar informe</button>
