        ...
        <section class="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200 dark:bg-slate-900 dark:ring-slate-800">
            ...
            <div class="mt-4 grid gap-4 md:grid-cols-2">
                <label class="space-y-2">
                    <span class="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">Centro / facultad principal <span class="text-rose-600 dark:text-rose-300" aria-label="Campo requerido">*</span></span>
                ...
                <label class="space-y-2">
                    <span class="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">Código <span class="text-rose-600 dark:text-rose-300" aria-label="Campo requerido">*</span></span>
                ...
                <label class="space-y-2">
                    <span class="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">Tipo de programa <span class="text-rose-600 dark:text-rose-300" aria-label="Campo requerido">*</span></span>
                ...
                <label class="space-y-2 md:col-span-2">
                    <span class="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">Nombre <span class="text-rose-600 dark:text-rose-300" aria-label="Campo requerido">*</span></span>
        ...
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/50 px-4 py-6" wire:click.self="closeCreateAsignaturaModal">
            <section class="w-full max-w-2xl rounded-3xl bg-white p-6 shadow-2xl dark:bg-slate-900">
                ...
                <form wire:submit.prevent="createAsignaturaAndAttach">
                    <div class="mt-6 grid gap-4 md:grid-cols-2">
                        <label class="space-y-2"><span class="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">Código <span class="text-rose-600 dark:text-rose-300" aria-label="Campo requerido">*</span></span><input wire:model="newAsignatura.codigo" type="text" required class="w-full rounded-xl border-slate-300 bg-white text-sm text-slate-900 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100">@error('newAsignatura.codigo')<p class="text-xs font-medium text-rose-600">{{ $message }}</p>@enderror</label>
                        <label class="space-y-2 md:col-span-2"><span class="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">Nombre <span class="text-rose-600 dark:text-rose-300" aria-label="Campo requerido">*</span></span><input wire:model="newAsignatura.nombre" type="text" required class="w-full rounded-xl border-slate-300 bg-white text-sm text-slate-900 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100">@error('newAsignatura.nombre')<p class="text-xs font-medium text-rose-600">{{ $message }}</p>@enderror</label>
                        <label class="space-y-2"><span class="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">Créditos <span class="text-rose-600 dark:text-rose-300" aria-label="Campo requerido">*</span></span><input wire:model="newAsignatura.creditos_academicos" type="number" min="0" step="0.01" required class="w-full rounded-xl border-slate-300 bg-white text-sm text-slate-900 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100">@error('newAsignatura.creditos_academicos')<p class="text-xs font-medium text-rose-600">{{ $message }}</p>@enderror</label>
                        <label class="space-y-2"><span class="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">Horas <span class="text-rose-600 dark:text-rose-300" aria-label="Campo requerido">*</span></span><input wire:model="newAsignatura.horas_academicas" type="number" min="1" required class="w-full rounded-xl border-slate-300 bg-white text-sm text-slate-900 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100">@error('newAsignatura.horas_academicas')<p class="text-xs font-medium text-rose-600">{{ $message }}</p>@enderror</label>
                        <label class="space-y-2 md:col-span-2">
                            <span class="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500 dark:text-slate-400">Documento de descripción mínima <span class="text-rose-600 dark:text-rose-300" aria-label="Campo requerido">*</span></span>
