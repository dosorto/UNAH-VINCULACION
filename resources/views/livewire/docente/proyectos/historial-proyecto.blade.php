                ...
                <div class="container">
                    ...
                    <div class="section1">
                        ...
                        <table class="table_datos1">
                                    ...
                                    <div class="date-container">
                                        <div class="date-part">
                                            <input disabled type="text" class="input-field"
                                                value="{{ $proyecto->fecha_registro ? $proyecto->fecha_registro->format('d') : '' }}">
                                        </div>
                                        <div class="date-part">
                                            <input disabled type="text" class="input-field"
                                                value="{{ $proyecto->fecha_registro ? $proyecto->fecha_registro->format('m') : '' }}">
                                        </div>
                                        <div class="date-part">
                                            <input disabled type="text" class="input-field"
                                                value="{{ $proyecto->fecha_registro ? $proyecto->fecha_registro->format('Y') : '' }}">
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="sub-header" colspan="1">Facultad /Centro Universitario Regional/Instituto
                                    Tecnológico</td>
                                <td class="full-width" colspan="4">
                                    <ul>
                            ...
                            <tr>
                                <td class="sub-header" colspan="1">Escuela, Departamento Académico, Técnicos
                                    Universitarios, Instituto de Investigación, Observatorio, Consultorio</td>
                                <td class="full-width" colspan="4">
                                    <ul>
                            ...
                            <tr>
                                <td class="sub-header" colspan="1">Líneas de investigación de la unidad académica
                                </td>
                                <td class="full-width" colspan="4">
                                    <input disabled type="text" class="input-field"
                                        placeholder="Ingrese el programa al que pertenece"
                            ...
                            <tr>
                                <th class="full-width1" rowspan="1">4. Alineamiento con ejes prioritarios de la
                                    UNAH</th>
                                ...
                                <td class="full-width" colspan="1">
                                    <div class="date-container">
                                        <div class="date-part">
                                            <span class="date-label">Día</span>
                                            <input disabled type="text" class="input-field"
                                                value="{{ $proyecto->fecha_inicio ? $proyecto->fecha_inicio->format('d') : '' }}">
                                        </div>
                                        <div class="date-part">
                                            <span class="date-label">Mes</span>
                                            <input disabled type="text" class="input-field"
                                                value="{{ $proyecto->fecha_inicio ? $proyecto->fecha_inicio->format('m') : '' }}">
                                        </div>
                                        <div class="date-part">
                                            <span class="date-label">Año</span>
                                            <input disabled type="text" class="input-field"
                                                value="{{ $proyecto->fecha_inicio ? $proyecto->fecha_inicio->format('Y') : '' }}">
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="full-width" colspan="1">
                                    <div class="date-container">
                                        <div class="date-part">
                                            <span class="date-label">Día</span>
                                            <input disabled type="text" class="input-field"
                                                value="{{ $proyecto->fecha_finalizacion ? $proyecto->fecha_finalizacion->format('d') : '' }}">
                                        </div>
                                        <div class="date-part">
                                            <span class="date-label">Mes</span>
                                            <input disabled type="text" class="input-field"
                                                value="{{ $proyecto->fecha_finalizacion ? $proyecto->fecha_finalizacion->format('m') : '' }}">
                                        </div>
                                        <div class="date-part">
                                            <span class="date-label">Año</span>
                                            <input disabled type="text" class="input-field"
                                                value="{{ $proyecto->fecha_finalizacion ? $proyecto->fecha_finalizacion->format('Y') : '' }}">
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <th class="full-width1" rowspan="5" colspan="1">7. Beneficiarios directos
                                    (número aproximado)</th>
                                ...
                                <td class="full-width" colspan="1">
                                    <div class="date-container">
                                        <div class="date-part">
                                            ...
                                            <input disabled type="text" class="input-field"
                                                value="{{ $proyecto->indigenas_hombres }}" placeholder="0">
                                        </div>
                                        <div class="date-part">
                                            <span class="date-label">Mujeres</span>
                                            <input disabled type="text" class="input-field"
                                                value="{{ $proyecto->indigenas_mujeres }}" placeholder="0">
                                        </div>
                                    </div>
                                </td>
                                <td class="full-width" colspan="1">
                                    <div class="date-container">
                                        <div class="date-part">
                                            <span class="date-label">Hombres</span>
                                            <input disabled type="text" class="input-field"
                                                value="{{ $proyecto->afroamericanos_hombres }}" placeholder="0">
                                        </div>
                                        <div class="date-part">
                                            <span class="date-label">Mujeres</span>
                                            <input disabled type="text" class="input-field"
                                                value="{{ $proyecto->afroamericanos_mujeres }}" placeholder="0">
                                        </div>
                                    </div>
                                </td>
                                <td class="full-width" colspan="1">
                                    <div class="date-container">
                                        <div class="date-part">
                                            <span class="date-label">Hombres</span>
                                            <input disabled type="text" class="input-field"
                                                value="{{ $proyecto->mestizos_hombres }}" placeholder="0">
                                        </div>
                                        <div class="date-part">
                                            <span class="date-label">Mujeres</span>
                                            <input disabled type="text" class="input-field"
                                                value="{{ $proyecto->mestizos_mujeres }}" placeholder="0">
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td class="sub-header" colspan="2">7. Población beneficiada (número aproximado)
                                </td>
                                ...
                                <td class="full-width" colspan="2">
                                    @if (is_array($proyecto->caserio) && count($proyecto->caserio) > 0)
                                        @foreach ($proyecto->caserio as $caserio)
                                            <input disabled type="text" class="input-field"
                                                placeholder="Ingrese el caserío" value="{{ $caserio }}"
                                                disabled>
                                        @endforeach
                                    @else
                                        <input disabled type="text" class="input-field"
                            ...
                            <tr>
                                ...
                                <td class="full-width" colspan="2">
                                    ...
                                    @else
                                        <input disabled type="text" class="input-field"
                                            placeholder="Ingrese el país" value="{{ $proyecto->pais ?? '' }}"
                                            disabled>
                                    @endif
                                </td>
                            </tr>
                            ...
                            <tr>
                                <th class="full-width1" colspan="6"> 13. Presupuesto del Proyecto</th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th class="full-width1" colspan="6"> En caso de superávit o rentabilidad en el
                                    proyecto,
                                    haga un
                                    desglose detallado
                                    en que se va a invertir el superávit según las normas de ejecución presupuestaria de
                                    la
                                    UNAH
                                </th>
                            </tr>
                    ...
                    <div class="section2">
                        ...
                        <table class="table_datos1">
                            ...
                            <tr>
                                <th class="full-width1" colspan="6">Integrantes del equipo docente permanente
                                    tiempo completo
                            ...
                            @endforelse
                            <tr>
                                <th class="full-width1" colspan="6">Integrantes del equipo de cooperación
                                    internacional
                                    (Agregar más líneas de ser necesario)</th>
                            </tr>
                            <tr>
                            ...
                            @empty
                                <tr>
                                    ...
                                    " colspan="6">
                                        <input disabled type="text" class="input-field"
                                            placeholder="Aqui van los integrantes internacionales"
                                            value="No hay integrantes" disabled>
                                    </td>
                                </tr>
                            @endforelse
                        </table>
                    ...
                    <div class="section3">
                        ...
                        <table class="table_datos1">
                            ...
                            <tr>
                                ...
                                <td class="sub-header" colspan="6">Desglose del tipo de participación de
                                    estudiantes:</td>
                            </tr>
                            <tr>
                                <td class="sub-header" colspan="1">Hombres</td>
                            ...
                            <tr>
                                ...
                                <td class="sub-header" colspan="1">TOTAL</td>
                                <td class="sub-header" colspan="6">Desglose del tipo de participación de personal
                                    docente:</td>
                            </tr>
                            <tr>
                                <td class="sub-header" colspan="1">Hombres</td>
                            ...
                            <tr>
                                ...
                                <td class="sub-header" colspan="2" rowspan="2">Asistentes técnicos laboratorios
                                    / Instructores</td>
                            </tr>
                            <tr>
                                <td class="full-width" colspan="1">
                    ...
                    <div class="section4">
                        ...
                        <table class="table_datos2">
                            <tr>
                                <th class="header" colspan="7">En caso de que la contraparte sea nacional (añadir
                                    una
                                    tabla
                            ...
                            @forelse ($proyecto->entidad_contraparte as $entidad)
                                ...
                                <tr>
                                    ...
                                    <td class="full-width" colspan="3">
                                        <input disabled type="text" class="input-field"
                                            ...
                                            value="{{ $entidad->cargo_contacto ?? '' }}" disabled>
                                    </td>
                                    <td class="sub-header" colspan="1">Teléfono</td>
                                    <td class="full-width" colspan="2">
                                        <input disabled type="text" class="input-field"
                                            placeholder="Ingrese el teléfono" value="{{ $entidad->telefono }}"
                                            disabled>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="sub-header" colspan="1">Tipo de instrumento que da lugar a la
                                        alianza</td>
                                    <td class="sub-header1" colspan="2">Carta formal de solicitud a la unidad
                                        académica <br>
                                        <input disabled type="checkbox" class="No"
                                ...
                                <tr>
                                    <td class="sub-header" colspan="1">Breve descripción de los compromisos
                                        asumidos por la contraparte</td>
                                    <td class="full-width" colspan="6">
                                ...
                                <tr>
                                    <td class="full-width
                                        ...
                                        <input disabled type="text" class="input-field"
                                            ...
                                            value="{{ $instrumento->tipo_documento_display }}" disabled>
                                    </td>
                                    <td class="full-width
                                        " colspan="3">
                    ...
                    <div class="section2">
                        ...
                        <table class="table_datos3">
                            <tr>
                                <th class="header" colspan="19">1. Descripción del proyecto: (Explicar brevemente en
                                    qué consiste el proyecto,
                                    los antecedentes que dieron su origen y la importancia que tiene para los objetivos
                                    estratégicos de la UNAH) De 150 a 250 palabras</th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th class="header" colspan="19">2. Descripción de los participantes del proyecto
                                    (Descripción breve de las unidades académicas participantes y su alineamiento con la
                                    estrategia de
                                    vinculación de la unidad. También se realizará una breve descripción de las
                                    contrapartes participantes, a qué se dedican y cómo se alinea el proyecto a los
                                    planes estratégicos)</th>
                            </tr>
                            <tr>
                                <td class="full-width" colspan="19">
                            ...
                            <tr>
                                <th class="header" colspan="19">3. Definición del problema: Breve descripción del
                                    problema que se desea resolver, indicando línea base que se tendrá en
                            ...
                            <tr>
                                <td class="header" colspan="19">8. Impacto que se desea generar en el proyecto
                                    </th>
                            </tr>
                            <tr>
                                <td class="full-width" colspan="19">
                                    <textarea disabled cols="30" rows="6" class="input-field" placeholder="Impacto deseado">{{ $proyecto->impacto_deseado ?? '' }}</textarea>
                                </td>
                            </tr>
                            <tr>
                                <td class="header" colspan="19">9. Objetivos de Desarrollo Sostenible (ODS) a los
                                    que se contribuye: Indicar el o los
                                    ODS a los que pretende contribuir el proyecto y las metas correspondientes. Para
                                    esta descripción deberá basarse en el documento de ODS
                                    que puede consultar en el siguiente enlace: <a style=""
                                        href="https://www.un.org/sustainabledevelopment/es/objetivos-de-desarrollo-sostenible/">Objetivos
                                        y metas de desarrollo sostenible - Desarrollo Sostenible </a></th>
                            </tr>
                            <tr>
                            ...
                            @empty
                                <tr>
                                    <td class="full-width" colspan="19">
                                        <textarea disabled cols="30" rows="6" class="input-field" placeholder="No hay ODS registrados">No hay Objetivos de Desarrollo Sostenible registrados para este proyecto</textarea>
                                    </td>
                                </tr>
                            @endforelse

                            <tr>
                                <td class="header" colspan="19">10. Alineamiento con lo esencial de la reforma de
                                    la UNAH (detalle brevemente cómo se alinean los ejes de lo esencial de la reforma en
                                    la ejecución de este proyecto)</th>
                            </tr>
                            <tr>
                                <td class="full-width" colspan="19">
                                    <textarea disabled cols="30" rows="6" class="input-field" placeholder="Alineamiento con la reforma">{{ $proyecto->alineamiento_reforma ?? 'No hay información específica registrada para este campo' }}</textarea>
                                </td>
                            </tr>
                            <tr>
                                    ...
                                    @if ($objetivo->resultados->count() > 0)
                                        @foreach ($objetivo->resultados as $indexRes => $resultado)
                                            <tr>
                                                ...
                                                @if ($indexRes == 0)
                                                    <td class="full-width" colspan="4"
                                                        rowspan="{{ $objetivo->resultados->count() }}">
                    ...
                    <div class="section2">
                        ...
                        <table class="table_datos3">
                            <tr>
                                <td class="header" colspan="19">6.1. Aporte institucional (manifestado en
                                    lempiras)</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="sub-header" colspan="7">f) Costos indirectos por infraestructura
                                    universidad (depreciación de equipo, calculado sobre la sumatoria de los conceptos a
                                    – e)</td>
                            ...
                            <tr>
                                <td class="sub-header" colspan="7">g) Costos indirectos por servicios públicos
                                    (internet, electricidad, otros, calculado sobre la sumatoria de los conceptos a – e)
                                </td>
                                <td class="sub-header" colspan="3">%</td>
                                <td class="full-width" colspan="3">
                                    <input disabled type="text" class="input-field"
                    ...
                    <div class="section2">
                        ...
                        <table class="table_datos3">
                            ...
                            <tr>
                                <th class="header" colspan="19">10. DDescripción de actividades del proyecto
                                    (Descripción de todas las actividades enmarcadas en el proyecto, las cuales pueden
                                    ser,
                                    ...
                                    presentación de informe intermedio o parciales, presentación del informe final,
                                    proceso de evaluación, proceso de sistematización,
                            ...
                            <tr>
                                ...
                                <td class="s3" colspan="4"> {{ $actividad->fecha_inicio }} -
                                    {{ $actividad->fecha_finalizacion }}</td>
                                <td class="" colspan="5">
                        ...
                        @empty
                            <td class="full-width
                                    " colspan="19">
                                <input disabled type="text" class="input-field"
                                    placeholder="Ingrese el departamento" value="No hay actividades" disabled>
                    ...
                    <div class="section3">
                        ...
                        <table class="table_datos4">
                            <tr>
                                <td class="sub-header" colspan="2">Coordinador(a) del Comité de Vinculación <br>
                                    de la
                                    facultad o Campus Universitario</td>
                                <td class="sub-header" colspan="2">Decano(a) o Director(a) del Campus
                                    Universitario
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th class="header" colspan="2">Firma del Coordinador(a) del Comité de Vinculación
                                    <br>
                                    de
