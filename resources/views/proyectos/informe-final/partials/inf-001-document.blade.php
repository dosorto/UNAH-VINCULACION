...
<main class="inf001-document">
    ...
    <table class="inf-table inf-avoid"><tr><th class="inf-header-blue">Coordinador del proyecto por la UNAH</th><th class="inf-header-blue">Jefe de la Unidad Académica que lidera el proyecto</th></tr><tr><td class="inf-signature-cell">@if(data_get($firmas,'coordinador.sello'))<img src="{{ data_get($firmas,'coordinador.sello') }}" alt="">@endif @if(data_get($firmas,'coordinador.firma'))<img src="{{ data_get($firmas,'coordinador.firma') }}" alt="">@endif<div class="inf-signature-name">Nombre: {{ data_get($firmas,'coordinador.nombre') ?: $coordinador?->nombre }}<br>Firma del profesor/a responsable del proyecto</div></td><td class="inf-signature-cell">@if(data_get($firmas,'jefe.sello'))<img src="{{ data_get($firmas,'jefe.sello') }}" alt="">@endif @if(data_get($firmas,'jefe.firma'))<img src="{{ data_get($firmas,'jefe.firma') }}" alt="">@endif<div class="inf-signature-name">Nombre: {{ data_get($firmas,'jefe.nombre') }}<br>Firma del Jefe/a de la Unidad Académica</div></td></tr><tr><th class="inf-header-blue">Coordinador(a) del Comité de Vinculación</th><th class="inf-header-blue">Decano(a) o Director(a) del Centro Regional</th></tr><tr><td class="inf-signature-cell">@if(data_get($firmas,'enlace.sello'))<img src="{{ data_get($firmas,'enlace.sello') }}" alt="">@endif @if(data_get($firmas,'enlace.firma'))<img src="{{ data_get($firmas,'enlace.firma') }}" alt="">@endif<div class="inf-signature-name">Nombre: {{ data_get($firmas,'enlace.nombre') }}<br>Firma del coordinador del Comité Local</div></td><td class="inf-signature-cell">@if(data_get($firmas,'decano.sello'))<img src="{{ data_get($firmas,'decano.sello') }}" alt="">@endif @if(data_get($firmas,'decano.firma'))<img src="{{ data_get($firmas,'decano.firma') }}" alt="">@endif<div class="inf-signature-name">Nombre: {{ data_get($firmas,'decano.nombre') }}<br>Firma y sello del Decano(a) o Director(a)</div></td></tr></table>
