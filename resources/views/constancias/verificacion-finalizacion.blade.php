...
<head>
    ...
    <title>Verificación de Constancia de Finalización</title>
    <style>
...
<body>
    <main>
        <article>
            ...
            <h1>Verificación de Constancia de Finalización</h1>
            <dl>
            ...
            @if($puedeDescargarPublicamente)
                <a href="{{ route('constancias.finalizacion.verificar.pdf', ['token' => $token]) }}" class="download">Descargar constancia vigente</a>
            @elseif(! $vigente)
