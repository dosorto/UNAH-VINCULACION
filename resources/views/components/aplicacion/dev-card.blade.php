...
<div class="flex items-center gap-4 p-4 bg-white dark:bg-gray-900 shadow-sm rounded-xl border border-gray-200 dark:border-gray-700 w-full max-w-2xl mx-auto">
    ...
    <div class="flex flex-col">
        <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-100">{{ $name }}</h3>
        ...
        <div class="flex space-x-3 mt-2">
            @if ($github)
                <a href="{{ $github }}" target="_blank" class="transition">
                    <img src="{{ asset('images/github.svg') }}" alt="GitHub" class="w-5 h-5 dark:invert" />
                </a>
            @endif
            @if ($linkedin)
                <a href="{{ $linkedin }}" target="_blank" class="transition">
                    <img src="{{ asset('images/linkedin.svg') }}" alt="LinkedIn" class="w-5 h-5 dark:invert" />
                </a>
            @endif
            @if ($instagram)
                <a href="{{ $instagram }}" target="_blank" class="transition">
                    <img src="{{ asset('images/instagram.svg') }}" alt="Instagram" class="w-5 h-5 dark:invert" />
                </a>
            @endif
        </div>
    </div>
