        ...
        <header class="shadow-lg p-2 bg-white dark:bg-gray-800">
            ...
            <div class="container mx-auto flex flex-col md:flex-row items-center justify-between gap-5 ">
                <div class="flex items-center flex-wrap justify-center">
                    <img src="{{asset('images/Image/Imagen2.png')}}" alt="UNAH Logo" class="max-w-full h-auto  md:w-[65%]">
                </div>
                ...
                <div class="relative  overflow-hidden rounded-lg h-full">
                    ...
                    @foreach($slides as $index => $slide)
                        <div class="hidden duration-700 ease-in-out" data-carousel-item @if($index == 0) data-carousel-item="active" @endif>
                            <img src="{{ asset('storage/' . $slide->image_url) }}" class="absolute block w-full h-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="Slide {{ $index + 1 }}">
                        </div>
                    @endforeach
                </div>
                <!-- Slider controls -->
        ...
        <div class="bg-blue-900  text-white p-2 mb-2 dark:bg-gray-800">
            <div class="container mx-auto">
                ...
                <ol class="list-decimal list-inside ">
                    ...
                    <li>Suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat.</li>
                </ol>
            </div>
        </div>
