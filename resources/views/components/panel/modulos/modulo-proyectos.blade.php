...
@section('titulo')
    ...
    <x-panel.navbar-horizontal.navbar-horizontal>
        ...
        <x-panel.navbar-horizontal.item titulo="Revisión de Informes" ruta="listarInformesSolicitado" permiso="proyectos-admin-informenes" />
        <x-panel.navbar-horizontal.item titulo="Revisión Final" ruta="listarProyectoRevisionFinal" permiso="proyectos-admin-revision-final" />
    </x-panel.navbar-horizontal.navbar-horizontal>
@endsection
