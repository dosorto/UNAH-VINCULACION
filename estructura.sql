...
--
-- Host: 127.0.0.1    Database: vinculacion
-- ------------------------------------------------------
...
CREATE TABLE `cargo_firma` (
  ...
  `tipo_estado_id` int DEFAULT NULL,
  `estado_siguiente_id` int DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `proyecto` (
  ...
  KEY `proyecto_ciudad_id_foreign` (`ciudad_id`),
  ...
  CONSTRAINT `proyecto_ciudad_id_foreign` FOREIGN KEY (`ciudad_id`) REFERENCES `ciudad` (`id`),
...
-- Dump completed on 2025-03-24 12:55:03
