...
class ConstanciaFinalizacionProyecto extends Model
{
    ...
    protected $table = 'constancias_finalizacion_proyecto';
    ...
    public function informeFinal(): BelongsTo { return $this->belongsTo(InformeFinalProyecto::class, 'informe_final_proyecto_id'); }
    public function documentoProyecto(): BelongsTo { return $this->belongsTo(DocumentoProyecto::class, 'documento_proyecto_id'); }
    ...
    public function puedeDescargarse(): bool { return $this->estado === self::ESTADO_EMITIDA && blank($this->anulada_en) && filled($this->ruta_archivo); }
}
