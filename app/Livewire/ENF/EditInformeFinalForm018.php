...
class EditInformeFinalForm018 extends Component
{
    use WithFileUploads;
    ...
    {
        abort_unless($accion->codigo_formulario === 'FORM-DVUS-018', 404);
    ...
    public function validarInforme(): void
    {
        ...
        $this->mensaje = 'El informe final FORM-DVUS-018 quedo marcado como completo.';
    }
    ...
    public function updatedFotografiasTemporales(): void
    {
        ...
        foreach ($this->fotografiasTemporales as $index => $foto) {
            ...
            $this->accion->documentos()->create([
                ...
                'descripcion' => 'Fotografia del informe final FORM-DVUS-018.',
            ]);
            $guardadas++;
            $existentes++;
        }
    ...
    {
        return [
            'Participantes finales' => collect($this->participantes)->filter(fn ($row) => filled($row['nombre_completo'] ?? null))->count(),
    ...
    {
        return view('livewire.enf.edit-informe-final-form018', [
    ...
    private function loadAccion(EnfAccion $accion): EnfAccion
    {
        return $accion->load([
            ...
            'espaciosAprendizaje',
            'documentos',
            'sistematizacion.fases',
            'sistematizacion.documentos',
            'ods',
            'metasContribuye',
        ]);
    }
    ...
    private function validationAttributes(): array
    {
        return [
            ...
            'general.modalidad_acreditacion' => 'tipo de accion ejecutada',
