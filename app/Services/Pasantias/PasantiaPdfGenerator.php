...
class PasantiaPdfGenerator
{
    ...
    public function seccionesFormulario(): array
    {
        return [
            ...
            'III. Descripción de la experiencia y resultados' => ['Descripción de la experiencia y resultados'=>'descripcion_experiencia','Descripción del cargo'=>'descripcion_cargo','Resumen de responsabilidades y tareas'=>'resumen_responsabilidades','Nombre del departamento o área'=>'area_departamento','Área de conocimiento que se aplicará'=>'area_conocimiento','Código de asignatura'=>'codigo_asignatura','Nombre de asignatura'=>'nombre_asignatura','Descripción de conocimientos teóricos'=>'descripcion_conocimientos_teoricos','Habilidades por desarrollar'=>'habilidades_desarrollar','Pasantía remunerada (Sí/No)'=>'pasantia_remunerada','Monto de remuneración'=>'monto_remuneracion'],
