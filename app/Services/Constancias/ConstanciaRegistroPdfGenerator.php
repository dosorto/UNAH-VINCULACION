...
class ConstanciaRegistroPdfGenerator
{
    public function content(ConstanciaRegistroProyecto $constancia): string
    {
        ...
        try {
            $pdf = Pdf::loadView('pdf.constancias.constancia-registro-proyecto', [
