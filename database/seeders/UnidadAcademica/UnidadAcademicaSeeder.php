...
class UnidadAcademicaSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $centroDanli = FacultadCentro::create(['nombre' => 'UNAH-TEC Danli Centro Tecnológico de Danlí', 'es_facultad' => false, 'siglas' => 'UNAH-TEC Danli', 'campus_id' => $UNAH_ELPARAISO->id]);
        $centroCurNo = FacultadCentro::create(['nombre' => 'CURNO Centro Universitario Regional Nororiental', 'es_facultad' => false, 'siglas' => 'CURNO', 'campus_id' => $UNAH_OLANCHO->id]);
        $centroUnahVs = FacultadCentro::create(['nombre' => 'UNAH-VS UNAH Valle de Sula', 'es_facultad' => false, 'siglas' => 'UNAH-VS', 'campus_id' => $UNAH_CORTES->id]);
        $centroCurc = FacultadCentro::create(['nombre' => 'CURC Centro Universitario Regional del Centro', 'es_facultad' => false, 'siglas' => 'CURC', 'campus_id' => $UNAH_COMAYAGUA->id]);
        $centroCurlA = FacultadCentro::create(['nombre' => 'CURLA Centro Universitario Regional de Litoral Atlántico', 'es_facultad' => false, 'siglas' => 'CURLA', 'campus_id' => $UNAH_ATLANTIDA->id]);
        $centroCurlP = FacultadCentro::create(['nombre' => 'CURLP Centro Universitario Regional del Litoral Pacífico', 'es_facultad' => false, 'siglas' => 'CURLP', 'campus_id' => $UNAH_CHOLUTECA->id]);
        $centroCuroc = FacultadCentro::create(['nombre' => 'CUROC Centro Universitario Regional de Occidente', 'es_facultad' => false, 'siglas' => 'CUROC', 'campus_id' => $UNAH_COPAN->id]);
        $centroAguan = FacultadCentro::create(['nombre' => 'UNAH-TEC AGUÁN Centro Tecnológico del Valle de Aguan', 'es_facultad' => false, 'siglas' => 'UNAH-TEC Aguán', 'campus_id' => $UNAH_YORO->id]);
