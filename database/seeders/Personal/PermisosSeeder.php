...
class PermisosSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $role->syncPermissions([
            ...
            'configuracion.logs', 'configuracion.perfil', 'configuracion.contactanos',
            ...
            'global.set-role', 'apariencia.slides', 'estudiante.admin',
        ...
        $roleEstudiante->syncPermissions([
            ...
            'global.set-role', 'tickets.ver', 'configuracion.perfil',
        ]);
    }
}
